    ...
    xmlhttp.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200) {
            ...
            regije.jugovzhodna = {
                ...
                soleInFakultete:"Pouk poteka v Osnovnih šolah, srednjih šolah, ter fakultetah brez omejitev.",
                omejitevGibanja: "Ni omejitev gibanja.",
                omejitveZbiranja: "Ni številčne omejitve zbiranja, 10 kvadratnih metrov na osebo v odprtih in zaprtih prostorih. Kulturne prireditve do 50% zmogljivosti sedišč.",
